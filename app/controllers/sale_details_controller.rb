class SaleDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sale_detail.save
        format.html { redirect_to @sale_detail.sale, notice: 'Sale detail was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @sale_detail.update(sale_detail_params)
        format.html { redirect_to @sale_detail.sale, notice: 'Sale detail was successfully updated.' }
  ...
  def destroy
    @sale_detail.destroy
    respond_to do |format|
      format.html { redirect_to @sale, notice: 'Sale detail was successfully destroyed.' }
  ...
  private
    ...
    def sale_detail_params
      params.require(:sale_detail).permit(:name_item, :qty, :subtotal,:sale_id)
    end
    def set_sale
