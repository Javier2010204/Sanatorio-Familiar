...
class SaleDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sale_detail" do
    assert_difference('SaleDetail.count') do
      post sale_details_url, params: { sale_detail: { name_item: @sale_detail.name_item, qty: @sale_detail.qty, subtotal: @sale_detail.subtotal } }
    end
  ...
  test "should update sale_detail" do
    patch sale_detail_url(@sale_detail), params: { sale_detail: { name_item: @sale_detail.name_item, qty: @sale_detail.qty, subtotal: @sale_detail.subtotal } }
